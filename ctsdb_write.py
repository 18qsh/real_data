...
"""
loaddata = np.load(
    './results/informer_JFNG_data_15min_ftMS_sl96_ll48_pl24_dm512_nh8_el2_dl1_df2048_atprob_fc5_ebtimeF_dtTrue_mxTrue_test_0/real_prediction_JFNG_data_15min.npy')

loaddata2 = np.load(
    './results/informer_JFNG_data_15min_ftMS_sl96_ll48_pl24_dm512_nh8_el2_dl1_df2048_atprob_fc5_ebtimeF_dtTrue_mxTrue_test_0/real_prediction_B04.npy')
