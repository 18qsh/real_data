...
folder_path = './test_data/B15newdata'
extension = '.csv'
...
for i,j in zip(dir2, dir4):
    ...
    parser.add_argument('--root_path', type=str, default='./test_data/B15newdata', help='root path of the data file')
    ...
    data_parser = {
        ...
        'JFNG_data_15min_unpwv': {'data': i, 'T': 'tp', 'M': [5, 5, 5], 'S': [1, 1, 1], 'MS': [5, 5, 1]},
        'JFNG_pwvtp_15min': {'data': i, 'T': 'tp', 'M': [2, 2, 2], 'S': [1, 1, 1], 'MS': [2, 2, 1]},
        'JFNG_data_1h': {'data': i, 'T': 'tp', 'M': [6, 6, 6], 'S': [1, 1, 1], 'MS': [6, 6, 1]},
        'JFNG_data_15min_unwind': {'data': i, 'T': 'tp', 'M': [5, 5, 5], 'S': [1, 1, 1], 'MS': [5, 5, 1]},
        'Lightning_hka_data_15min_aws_chazhi_18_21': {'data': i, 'T': 'tp', 'M': [5, 5, 5], 'S': [1, 1, 1], 'MS': [5, 5, 1]},
        'Lightning_kp_data_15min_aws_chazhi_18_21': {'data': i, 'T': 'tp', 'M': [5, 5, 5], 'S': [1, 1, 1], 'MS': [5, 5, 1]},
        'pen_data_15min_aws_chazhi_18_21': {'data': i, 'T': 'tp', 'M': [5, 5, 5], 'S': [1, 1, 1], 'MS': [5, 5, 1]},
        'sek_data_15min_aws_cahzhi_18_21': {'data': i, 'T': 'tp', 'M': [5, 5, 5], 'S': [1, 1, 1], 'MS': [5, 5, 1]},
        'sha_data_15min_aws_chazhi_18_21': {'data': i, 'T': 'tp', 'M': [5, 5, 5], 'S': [1, 1, 1], 'MS': [5, 5, 1]},
        'tc_data_15min_aws_chazhi_18_21': {'data': i, 'T': 'tp', 'M': [5, 5, 5], 'S': [1, 1, 1], 'MS': [5, 5, 1]},
        'wlp_data_15min_aws_chazhi_18_21': {'data': i, 'T': 'tp', 'M': [5, 5, 5], 'S': [1, 1, 1], 'MS': [5, 5, 1]},
