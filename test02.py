...
parser.add_argument('--data_path', type=str, default='B04.csv', help='data file')
...
data_parser = {
    ...
    'JFNG_data_15min': {'data': args.data_path, 'T': 'tp', 'M': [6, 6, 1], 'S': [1, 1, 1], 'MS': [6, 6, 1]},
    'JFNG_data_15min_handle': {'data': args.data_path, 'T': 'tp', 'M': [6, 6, 1], 'S': [1, 1, 1], 'MS': [6, 6, 1]},
}
...
if args.data not in data_parser.keys():
    data_parser.update({args.data:{ 'data':args.data_path, 'T': args.target, 'M': [6, 6, 6], 'S': [1, 1, 1], 'MS': [6, 6, 1]},} )
    if args.data in data_parser.keys():
        data_info = data_parser[args.data]
        args.data_path = data_info['data']
        args.target = data_info['T']
